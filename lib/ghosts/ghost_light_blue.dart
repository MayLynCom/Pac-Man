...
import '../sprite_sheet/ghost_light_blue.dart';

class GhostLightBlue extends SimpleEnemy with ObjectCollision, AutomaticRandomMovement{

  GhostLightBlue(Vector2 position, Vector2 size)
      : super(
      position: position,
      size: size,
      speed: 30,
