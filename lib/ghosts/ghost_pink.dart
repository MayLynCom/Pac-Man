...
import '../sprite_sheet/ghost_pink.dart';

class GhostPink extends SimpleEnemy with ObjectCollision, AutomaticRandomMovement{

  GhostPink(Vector2 position, Vector2 size)
      : super(
      position: position,
      size: size,
      speed: 30,
